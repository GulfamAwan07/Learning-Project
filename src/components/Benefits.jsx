...
const Benefits = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center w-full p-10 gap-16 md:gap-20 mt-10 mb-6 overflow-hidden">
      <div
        ref={container}
        className="bg-[#F8FAFB] w-screen md:w-[36rem] flex justify-center items-center rounded-2xl"
      >
        <div className="relative bg-[#FFFFFF] w-screen md:w-[28rem] mt-12 rounded-2xl mb-6 show">
          ...
          <div className="absolute bg-white  rounded-2xl w-64  h-40 right-1 md:-right-16 -bottom-10 shadow-xl show">
      ...
      <div ref={txt}>
        <div className="mt-8 txt">
          ...
          <div className="flex flex-row gap-6 mt-4 txt">
            ...
            <div>
              ...
              <p className="text-gray-500">
                With advanced technology, we help you achieve top product
                quality.
